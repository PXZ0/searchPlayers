	...
	<body>
		...
		<main>
			...
			<?php
					...
					$sql='select * from usuario where id_usuario != "'.$_SESSION['id_usuario'].'" and
					nome like "%'.$caracter.'%";';
								...
								?>
									...
									?>
											...
											<form method="POST" action="registro_chat.php">
												...
												<input type="submit" style="background-color:#ff3c00;" class="btn btn-danger" name="conversar" value="Conversar">
											</form>
										</div>
									</div>
								</div>
