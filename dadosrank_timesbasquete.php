	...
	<tbody>
		<tr>
			<td>
				<?php 
					$foto=1; 
					include('fototime_ranking.php');  
				?>
			</td>
			<th scope="row"><?php echo($con['nome']); ?></th>
			<?php
				if(!empty($con['pontos'])){
					?>
